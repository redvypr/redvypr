...
from  redvypr.redvypr_datadict import create_redvypr_dict as redvypr_create_datadict
...
from redvypr.widgets.pydantic_config_widget import pydanticConfigWidget, datastreamMetadataWidget
...
logger = logging.getLogger('redvypr.device.generic_sensor')
