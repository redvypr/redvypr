...
logger = logging.getLogger('redvypr.device.temperature_array_sensors')
...
def process_TAR_data(dataline, data, device_info, loggerconfig):
    ...
    if datapacket_TAR is not None:
        ...
        datapacket_TAR_T = data_packets.create_redvypr_dict(device=devicename, tu=datapacket_TAR['_redvypr']['t'],
...
def process_TAR_raw(dataline, data, device_info):
    ...
    if datapacket is not None:
        ...
        datapacket_redvypr = data_packets.create_redvypr_dict(device=devicename, tu=data['_redvypr']['t'],
                                                              hostinfo=device_info['hostinfo'])
