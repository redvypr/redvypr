...
setup(name='redvypr',
      ...
      install_requires=['pyaml','pyqtgraph','netCDF4','pyqtconsole','pyserial','qtawesome','pynmea2','pydantic>2.0','xlsxwriter','pympler','matplotlib','python-dateutil','pympler','deepdiff'],
      classifiers=[
