...
for addr_str, pkt, expected in addresses_test:
    ...
    if expected != "KeyError":
        match_result = addr.matches_packetfilter(pkt)
...
if True:
    ...
    print("1", testaddr.matches_packetfilter(devaddr), devaddr.matches_packetfilter(testaddr))

    print("apkt1 matches devaddr", apkt1.matches_packetfilter(devaddr))
    print("devaddr matches apkt1", devaddr.matches_packetfilter(apkt1))
    print("apkt1_strict:{}\n matches devaddr:{}".format(apkt1_strict, apkt1_strict.matches_packetfilter(devaddr)))
