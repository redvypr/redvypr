...
cal_const = CalibrationLinearFactor(coeff=2.0, channel=caladdr, address_apply=caladdr, datakey_result='foo')
cal_const2 = CalibrationLinearFactor(coeff=3.0, channel=caladdr2, address_apply=caladdr2)
